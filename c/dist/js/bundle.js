...
},{"./models/blogpost":2,"./router.js":3,"./views/blogform":4,"./views/blogpost":5,"backbone":10,"jquery":31}],2:[function(require,module,exports){
"use strict";
var Backbone = require('backbone');
...
var BlogPostCollection = Backbone.Collection.extend({
  model: BlogPost,
  url: 'http://tiny-lasagna-server.herokuapp.com/collections/karasblog'
});
...
},{"./models/blogpost":2,"./views/blogform":4,"./views/blogpost":5,"./views/blogpostdetail":6,"backbone":10,"jquery":31}],4:[function(require,module,exports){
"use strict";
var Backbone = require('backbone');
...
},{"../../templates/blogform.hbs":8,"backbone":10,"jquery":31}],5:[function(require,module,exports){
"use strict";
var Backbone = require('backbone');
...
},{"../../templates/blogpost.hbs":9,"backbone":10,"jquery":31}],6:[function(require,module,exports){
"use strict";
var Backbone = require('backbone');
...
},{"../../templates/blogdetail.hbs":7,"backbone":10,"jquery":31}],7:[function(require,module,exports){
"use strict";
...
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!DOCTYPE html>\n<h3>"
    ...
    + "\n\n\n<!--<button class=\"btn btn-primary home-button\">Home</button> -->\n";
},"useData":true});
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!DOCTYPE html>\n<div class=\"form-group\">\n  <label for=\"title\">Title</label>\n  <input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\" placeholder=\"Title\">\n</div>\n\n<div class=\"form-group\">\n  <label for=\"post\">Blog Post</label>\n  <textarea type=\"text\" class=\"form-control\" id=\"post\" name=\"body\" placeholder=\"Type Blog Post Here\" rows=\"3\"></textarea>\n</div>\n\n\n<button type=\"submit\" class=\"add-button btn btn-default\">Add</button>\n";
},"useData":true});

},{"hbsfy/runtime":30}],9:[function(require,module,exports){
"use strict";
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!DOCTYPE html>\n\n<a href=\"#title/"
    ...
    + "/\">"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</a>\n\n\n<!-- REMOVED POST SECTION FOR PROJECT PURPOSES-LIST OF POSTS-->\n";
},"useData":true});
...
},{"jquery":31,"underscore":32}],11:[function(require,module,exports){
'use strict';
