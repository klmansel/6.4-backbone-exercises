...
},{"./models/blogpost":2,"./views/blogpost":3,"./views/blogpostform":4,"jquery":28}],2:[function(require,module,exports){
"use strict";
...
var BlogPostCollection = Backbone.Collection.extend({
  model: BlogPost,
  url: 'https://tiny-lasagna-server.herokuapp.com/collections/karasfullblog'
});
